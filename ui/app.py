...
class StreamHunterApp(ctk.CTk):
    ...
    def load_channels_db(self):
        ...
        self.status_label.configure(text="Updating Worldwide Channels...", text_color=Theme.WARNING)
        self.channel_manager.fetch_channels(on_complete=lambda: self.after(0, self.on_db_loaded))
